...
from locomotion.robot_control_cmd_lcmt import robot_control_cmd_lcmt
from locomotion.file_send_lcmt import file_send_lcmt
...
def locomotion_main(keyboard, motion_id=0, duration=0):
    ...
    if keyboard:
        ...
        my_ctrl.num = motion_id
        my_ctrl.msg.life_count = duration
        while True:
            time.sleep(0.2)
